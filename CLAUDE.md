...
Este repositório é o kit de boas-vindas do framework ADCLAUDE.
...
_contexto/empresa.md — quem é o usuário, o que faz, como funciona o negócio
_contexto/preferencias.md — tom de voz, estilo de escrita, o que evitar
_contexto/estrategia.md — foco atual, prioridades, o que pode esperar
...
Verificar se existe um template relevante em templates/skills/. Se existir, usar como base e adaptar pro contexto do usuário
Perguntar: "Essa skill é específica pra esse projeto ou vai ser útil em qualquer projeto?"
...
Ler _contexto/empresa.md e _contexto/preferencias.md pra calibrar o conteúdo da skill ao contexto do negócio
Se a skill precisar de arquivos de apoio (templates, referências, exemplos), criar dentro da pasta da skill
Seguir o fluxo da skill-creator nativa do Claude Code
